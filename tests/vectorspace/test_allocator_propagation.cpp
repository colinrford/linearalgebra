...
int main()
{
  ...
  // Test 7: Propagation vs Non-Propagation (Comparison)
  {
    ...
    check(v_noprop.get_allocator().resource() != alloc.resource(),
          "Case B: Resources should differ (Default vs Monotonic)");
